...
public class RefreshToken {
    ...
    public RefreshToken(UUID id, String tokenHash, AuthUser authUser, Instant expiresAt, Instant createdAt) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public RefreshToken build() {
            return new RefreshToken(id, tokenHash, authUser, expiresAt, createdAt);
        }
    }
